...
package talendproject.cicd_0_1;
...
public class cicd implements TalendJob {
	static {System.setProperty("TalendJob.log", "cicd.log");}
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String projectName = "TALENDPROJECT";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ToXaoFvHEfCwDoFp5jCuEA", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TALENDPROJECT_cicd = new byte[0];
    static byte[] commonByteArray_TALENDPROJECT_cicd = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALENDPROJECT_cicd.length) {
				if(length < 1024 && commonByteArray_TALENDPROJECT_cicd.length == 0) {
   					commonByteArray_TALENDPROJECT_cicd = new byte[1024];
				} else {
   					commonByteArray_TALENDPROJECT_cicd = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALENDPROJECT_cicd, 0, length);
			strReturn = new String(commonByteArray_TALENDPROJECT_cicd, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TALENDPROJECT_cicd, 0, length);
			strReturn = new String(commonByteArray_TALENDPROJECT_cicd, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALENDPROJECT_cicd) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "QD3aCv_");
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"customer_id","email","name",});        
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"D:/Downloads/customers.json\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("customer_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("email")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("name")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "D:/Downloads/customers.json";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("D:/Downloads/customers.json", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_1");
                ...
                if(!((Object)("D:/Downloads/customers.json") instanceof java.io.InputStream)){
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'cicd' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_ToXaoFvHEfCwDoFp5jCuEA");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-08T06:50:06.263556400Z");
        ...
        try {
            ...
            java.io.InputStream inContext = cicd.class.getClassLoader().getResourceAsStream("talendproject/cicd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = cicd.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'cicd' - Started.");
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'cicd' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     78294 characters generated by Talend Cloud Data Management Platform 
 *     on the 8 July 2025 at 12:20:06 pm IST
 ************************************************************************************************/